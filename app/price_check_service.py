...
async def _fetch_httpx(url: str, extra_headers: dict | None = None) -> tuple[str | None, str | None]:
    import httpx
...
async def check_price(
    ...
    if effective_engine == "cloudscraper":
        ...
        html, fetch_error = await _fetch_httpx(link_url, adapter.fetch_headers(link_url) if adapter else None)
